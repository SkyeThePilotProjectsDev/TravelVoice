...
class CustomAudioFileWaveforms extends StatefulWidget {
  ...
  @override
  State<CustomAudioFileWaveforms> createState() => _AudioFileWaveformsState();
}

class _AudioFileWaveformsState extends State<CustomAudioFileWaveforms>
  ...
  void _handleScrubberSeekUpdate(DragUpdateDetails details) {
    ...
    seekTo(widget.playerController, seekPosition.toInt());
  }
  ...
  Future<void> seekTo(PlayerController controller, int progress) async {
    if (progress < 0) return;
    await AudioWaveformsInterface.instance
        .seekTo(controller.playerKey, progress);
